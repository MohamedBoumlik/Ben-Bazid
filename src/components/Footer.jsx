        ...
        <Container>
            <Row>
                ...
                <Col>
                    <div className="Site">
                        <div className='d-flex m-auto'>
                            <VscGlobe style={{color: '#DD866E',fontSize: '36px', marginTop: '3px', marginRight: '10px'}}/>
                ...
                <Col>
                    <FooterLink href="#">
                        <div className='d-flex m-auto'>
                            <RiCustomerService2Fill style={{color: '#DD866E',fontSize: '36px', marginTop: '3px', marginRight: '10px'}}/>
